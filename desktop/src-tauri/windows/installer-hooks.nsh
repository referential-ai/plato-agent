...
Function ${prefix}PlatoShutdownDaemons
  ...
  Pop $0
  ${If} $0 != 0
    DetailPrint "Platonic daemon shutdown failed: $0"
    Call ${prefix}PlatoReleaseInstallerGate
    Abort "Platonic has an active run or its local daemon could not be stopped."
  ${EndIf}
FunctionEnd
!macroend
...
!macro NSIS_HOOK_PREINSTALL
  ...
  Pop $0
  ${If} $0 != "ok"
    Abort "Another Platonic installation, update, or daemon start is in progress."
  ${EndIf}
