...
Revision 4 — **Draft**, not adopted. Rev 2 folded closure review R1–R9 (direction confirmed: Tauri client, shared daemon ownership, in-repo home, Windows named pipes). Rev 3 added cross-platform scope per human direction: Windows, macOS, and Linux all ship; Windows first. Rev 4 folds closure items C10–C12. No phase goes `Ready for dev` against a Draft.
...
- Lead closure reviews 2026-07-12/13 (PR #140: R1–R9, C10–C12) are design input.
...
- Lead re-review confirms R1–R9 (rev 2), the cross-platform scope (rev 3), and C10–C12 (rev 4) are folded.
